...
def center_crop(img, crop_size=None):
    '''
    中心裁切
    :param img: [W, H] or [W, H, C]
    :param crop_size: [W, H] or [W] or [H]
    :return:
    '''
...
def train_transform(p=1, img_size=(256, 256), mean=mean, std=var):
...
def val_transform(p=1, img_size=(256, 256), mean=mean, std=var):
